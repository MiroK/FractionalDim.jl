...
# Dimless collision between bounding boxes
# NOTE if they don't collide then object don't
...
# Collision of point and box is dimless
function in{D}(p::Point{D}, box::Box{D})
    all(box.X[i] - EPS < p[i] < box.Y[i] for i in 1:D)
end
